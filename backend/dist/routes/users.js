...
router.post("/register", [
    ...
    (0, express_validator_1.check)("password", "Password must have 6 or more characteres").isLength({ min: 6 })
    ...
    try {
        ...
        return res.status(200).json({ message: "User registration was sucessfull" });
    }
    catch (e) {
